...
public class CardsMainActivity extends Activity implements Card.CardMenuListener<Card> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cardsList.setOnCardClickListener(new CardListView.CardClickListener() {
            ...
            public void onCardClick(int index, CardBase card, View view) {
                if (index == 0) {
                    startActivity(new Intent(CardsMainActivity.this, CustomCardActivity.class));
                }
            }
        });
